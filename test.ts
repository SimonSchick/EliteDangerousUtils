...
console.log(sha1('soldujghbidksfugbidfgbdoiujfghdikufg😋😋'))
console.log(createHash('sha1').update('soldujghbidksfugbidfgbdoiujfghdikufg😋😋').digest('hex'))
