...
export interface APIShip {
    name: string;
    modules: {
        [name in OptionalSlots]?: APIShipModule;
    } & {
...
export interface CookieStore {
    findCookie(domain: string, path: string, key: string, cb: (error?: Error, data?: Cookie) => void): void;
...
export class EDCompanionAPI {
     ...
     */
    constructor(private httpRequest: HTTPClient, jar: CookieStore, private credentialFetcher: CredentialsFetcher) {
